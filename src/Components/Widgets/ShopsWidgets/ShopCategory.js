        ...
        <Box>
            ...
            <Grid container>
                <Box display='flex' marginBottom='1%'>
                    ...
                    <Grid item xs={5.5}>
                        <Box display='flex' flexDirection='column' alignItems='center' justifyContent='space-between' height='100%'>
                            <Box position='relative'>
                                <img src={Images.shops_rudraksha} width='100%' />
                            ...
                            <Box position='relative'>
                                <img src={Images.shops_books} width='100%' />
                    ...
                    <Grid item xs={5.5}>
                        <Box position='relative'>
                            <img src={Images.shops_consecrated} width='100%' />
                ...
                <Box display='flex' width='100%' marginBottom='1%'>
                    ...
                    <Grid item xs={2.9}>
                        <Box height='100%' position='relative'>
                            <img src={Images.shops_health} width='100%' height='100%' />
                    ...
                    <Grid item xs={5}>
                        <Box height='100%' position='relative'>
                            <img src={Images.shops_yoga} width='100%' height='100%' />
                    ...
                    <Grid item xs={2.9}>
                        <Box height='100%' position='relative'>
                            <img src={Images.shops_fast} width='100%' height='100%' />
                ...
                <Box display='flex' marginBottom='1%'>
                    ...
                    <Grid item xs={5.5}>
                        <Box height='100%' position='relative'>
                            <img src={Images.shops_spiritual} width='100%' height='100%' />
                    ...
                    <Grid item xs={5.5}>
                        <Box height='100%' position='relative'>
                            <img src={Images.shop_clothing} width='100%' height='100%' />
                ...
                <Box display='flex' marginLeft='10%' marginRight='10%' paddingTop='2%' paddingBottom='2%'>
                    <Box display='flex' flexDirection='column'>
                        <Box marginLeft='25%' marginRight='25%'>
                            <img src={Images.shop_authentic} width='100%' />
                        </Box>
                    ...
                    <Box display='flex' flexDirection='column'>
                        <Box marginLeft='25%' marginRight='25%'>
                            <img src={Images.shops_local} width='100%' />
                        </Box>
                    ...
                    <Box display='flex' flexDirection='column'>
                        <Box marginLeft='25%' marginRight='25%'>
                            <img src={Images.shops_traditional} width='100%' />
                        </Box>
                    ...
                    <Box display='flex' flexDirection='column'>
                        <Box marginLeft='25%' marginRight='25%'>
                            <img src={Images.shops_eco} width='100%' />
                        </Box>
