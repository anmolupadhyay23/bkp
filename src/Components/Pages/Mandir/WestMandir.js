...
const WestMandir = () => {
  return (
    <Box>
      <NewNavbar />
      <MandirIntro mandir_type={'West India Mandir'} mandir_image={"url('https://res.cloudinary.com/dmfhdyvji/image/upload/f_auto,q_auto/v1/bkp/images/mandir/clzsxndjyz5ghxcivf2u')"} />
