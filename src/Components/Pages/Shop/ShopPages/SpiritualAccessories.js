  ...
  return (
    <Box>
      ...
      <Box paddingTop='100px'></Box>
        ...
        <Box height='86vh' position='relative' bgcolor='rgba(255, 101, 5, 0.7)' sx={{ backgroundImage: "url('https://firebasestorage.googleapis.com/v0/b/future-it-c63d3.appspot.com/o/bkp%2Fshop_spiritual.png?alt=media&token=dce6da24-7953-4a1d-ba89-0057e1b4f44a')", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
