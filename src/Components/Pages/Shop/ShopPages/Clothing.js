  ...
  return (
    <Box>
      ...
      <Box paddingTop='100px'></Box>
        ...
        <Box height='86vh' position='relative' bgcolor='rgba(255, 101, 5, 0.7)' sx={{ backgroundImage: "url('https://firebasestorage.googleapis.com/v0/b/future-it-c63d3.appspot.com/o/bkp%2Fclothing.png?alt=media&token=39e86f2c-7203-4af2-9d49-e060c7d57b34')", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
