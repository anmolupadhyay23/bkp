...
const Healthandimmunity = () => {
  return (
    <Box>
        <NewNavbar/>
      <Box paddingTop='100px'></Box>
        <Box display={{ xs: 'none', sm: 'none', md: 'block', lg: 'block', xl: 'block' }}>
        <Box height='86vh' position='relative' bgcolor='rgba(255, 101, 5, 0.7)' sx={{ backgroundImage: "url('https://firebasestorage.googleapis.com/v0/b/future-it-c63d3.appspot.com/o/bkp%2Fhealthimmunity.png?alt=media&token=6af27935-0fc9-4ce4-a3c8-c9b6b3ac18d3')", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
...
export default Healthandimmunity
