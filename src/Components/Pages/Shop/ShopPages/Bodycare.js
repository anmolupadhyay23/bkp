  ...
  return (
    <Box>
      ...
      <Box paddingTop='100px'></Box>
        ...
        <Box height='86vh' position='relative' bgcolor='rgba(255, 101, 5, 0.7)' sx={{ backgroundImage: "url('https://firebasestorage.googleapis.com/v0/b/future-it-c63d3.appspot.com/o/bkp%2Fbodycare.png?alt=media&token=3025ea51-ed65-4766-af9b-9f1e052c40c4')", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
